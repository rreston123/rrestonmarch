create or replace PACKAGE            interface_to_fusion_pkg as
  ...
  */
  ...
  v_transaction_type_id        number := 300000030822210; --//W.O Receipt - Excess;
  v_rec_transaction_type_id    number := 300000003677499; --//W.O Receipt - Recovered ;
  v_transaction_source_type_id number := 300000030822207;
  v_lock_status                varchar2(50) := '2';
  v_process_status             varchar2(50) := '3';
  v_cost_component_code        varchar2(50) := 'ITEM_PRICE';

 procedure interface_to_ap_ptrs(sar_in        cbs_wam.billings.sar_number%type,
...
create or replace PACKAGE BODY            interface_to_fusion_pkg as
  ...
  procedure interface_excess(p_wonumber  in cbs_wam.staking_transactions.work_order_no%type,
    ...
    /*
      REVISION HISTORY
      v2.0.1 20-Oct-2023 rreston
            Remarks : add new procedure interface_to_ap_ptrs
                            : CR CBS-PTRS integration
